# Iowa State Data - Simple Implementation

## Basic State Information
STATE_NAME: Iowa
STATE_NAME_LOWER: iowa
STANDARDS_NAME: Iowa Core 21st Century Skills: Financial Literacy
STANDARDS_CODE: Iowa Code 256.11
STANDARDS_COUNT: 5
...
META_DESCRIPTION: Iowa Personal Finance Curriculum aligned to Iowa Core's 5 financial literacy areas. Complete 45-chapter program for grades 9-12 meeting half-unit graduation requirement.
KEYWORDS: Iowa personal finance, Iowa Core, 5 core areas, Iowa graduation requirement, half-unit financial literacy, iowa teachers

## Hero Section
HERO_TITLE: Iowa Personal Finance Curriculum
HERO_DESCRIPTION: Complete 45-chapter program aligned to Iowa Core's 5 financial literacy core areas with flexible delivery options for K-12 alignment.

## Quick Facts Box
QUICK_FACTS_STANDARDS: Iowa Core 21st Century Skills: Financial Literacy
...
CONTENT_AREA_2: Content Area 2: Income and Careers (10 chapters) - Career exploration, income sources, taxation, and workforce readiness
CONTENT_AREA_3: Content Area 3: Planning and Money Management (9 chapters) - Budgeting, banking, saving strategies, and cash flow management
CONTENT_AREA_4: Content Area 4: Credit and Debt Management (9 chapters) - Credit fundamentals, debt strategies, and major purchase financing
CONTENT_AREA_5: Content Area 5: Risk Management and Investing (8 chapters) - Insurance, risk assessment, investment strategies, and retirement planning
...
### Content Area 4: Credit and Debt Management (9 chapters)
Credit fundamentals, borrowing costs, credit scores, debt management, and major purchase decisions

### Content Area 5: Risk Management and Investing (8 chapters)
Insurance products, risk assessment, investment strategies, and retirement planning

## L-Chapter Mappings for Dev Team
L_CHAPTER_MAPPINGS: L-4→1.1|L-5→1.2|L-27→1.3|L-28→1.4|L-29→1.5|L-33→1.6|L-36+L-37→1.7|L-39+L-40→1.8|L-46→1.9|L-1→2.1|L-2→2.2|L-3→2.3|L-6→2.4|L-7→2.5|L-8→2.6|L-41→2.7|L-45→2.8|L-42→2.9|L-43→2.10|L-9→3.1|L-10→3.2|L-11→3.3|L-12→3.4|L-13→3.5|L-14→3.6|L-15→3.7|L-16→3.8|L-17→3.9|L-21→4.1|L-22→4.2|L-23→4.3|L-24→4.4|L-25→4.5|L-26→4.6|L-38→4.7|L-30→4.8|L-31→4.9|L-18→5.1|L-19→5.2|L-20→5.3|L-34→5.4|L-35→5.5|L-32→5.6|L-47→5.7|L-44→5.8

### Content Area 4: Credit and Debt Management
...
CHAPTERS_CONSOLIDATED: 2 combinations (L-36+L-37 into 1.7, L-39+L-40 into 1.8)
TOTAL_CHAPTERS: 45 distributed across 5 Iowa Content Areas
SPECIAL_REQUIREMENTS: Iowa tax specifics, agricultural economy context, Iowa workforce readiness integration
CURRICULUM_STATUS: Ready for implementation - all 45 chapters mapped to 5 core areas aligned K-12 with corrected L-chapter titles
