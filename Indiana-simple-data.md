# Indiana State Data - Simple Implementation
...
META_DESCRIPTION: Indiana Personal Finance Curriculum aligned to Indiana Academic Standards for Personal Financial Responsibility. Complete 45-chapter program for grades 9-12 meeting graduation requirements.
KEYWORDS: Indiana personal finance, Personal Financial Responsibility, Indiana graduation requirement, high school curriculum, indiana teachers

## Hero Section
HERO_TITLE: Indiana Personal Finance Curriculum
HERO_DESCRIPTION: Complete 45-chapter program ready to implement with interactive resources, teacher training, and bilingual support aligned to Indiana Academic Standards.

## Quick Facts Box
QUICK_FACTS_STANDARDS: Indiana Academic Standards for Personal Financial Responsibility
...
STANDARD_2: Standard 2: Income and Careers (12 chapters) - Career pathways, sources of income, entrepreneurship, and taxation
STANDARD_3: Standard 3: Managing Finances (7 chapters) - Developing budgets and using banking and financial services
STANDARD_4: Standard 4: Credit and Debt (8 chapters) - Responsible use of credit, understanding credit, and managing debt
STANDARD_5: Standard 5: Saving and Investing (8 chapters) - Wealth accumulation through various investment strategies
STANDARD_6: Standard 6: Risk Management (5 chapters) - Consumer protection, identifying financial risks, and using insurance
...
GATED_STANDARDS: Standard 4: Credit and Debt|Standard 5: Saving and Investing|Standard 6: Risk Management

GATED_FEATURES: Credit Score Simulator|Debt Management Calculator|Investment Portfolio Builder|Insurance Cost Analyzer|Risk Assessment Tool

## Indiana Resource Links
STATE_RESOURCES: Indiana Department of Education|https://www.in.gov/doe/|Personal Financial Responsibility Guide|/compliance/indiana|Standards Alignment Document|/alignment/indiana|Implementation Guide|/implementation/indiana|Teacher Training Options|/training/indiana

## L-Chapter Mappings for Dev Team
L_CHAPTER_MAPPINGS: L-4→1.1|L-5→1.2|L-34→1.3|L-37→1.4|L-38→1.5|L-1→2.1|L-2→2.2|L-3→2.3|L-6→2.4|L-7→2.5|L-28→2.6|L-29→2.7|L-30→2.8|L-43→2.9|L-44→2.10|L-18→2.11|L-40→2.12|L-8→3.1|L-9→3.2|L-10→3.3|L-11→3.4|L-12→3.5|L-13→3.6|L-14→3.7|L-19→4.1|L-20→4.2|L-21→4.3|L-22→4.4|L-23→4.5|L-24→4.6|L-39→4.7|L-31→4.8|L-15→5.1|L-25→5.2|L-26→5.3|L-16→5.4|L-17→5.5|L-41→5.6|L-42→5.7|L-45→5.8|L-35→6.1|L-36→6.2|L-27→6.3|L-32→6.4|L-33→6.5

## Implementation Summary for Dev Team
NEW_CHAPTERS_REQUIRED: 0 new chapters needed
CHAPTERS_TO_EXPAND: Indiana tax specifics, state banking context, career resources
MINOR_UPDATES: Indiana-specific economic context, tax rates, state regulations
