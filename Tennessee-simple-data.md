# Tennessee State Data - Simple Implementation

## Basic State Information
STATE_NAME: Tennessee
STATE_NAME_LOWER: tennessee
STANDARDS_NAME: Tennessee Personal Finance Standards
STANDARDS_CODE: TN Personal Finance Framework
STANDARDS_COUNT: 6
STANDARDS_TERM: Category
STANDARDS_TERM_PLURAL: Categories
COMPLIANCE_REQUIREMENT: 0.5 credit Personal Finance graduation requirement (since 2013, "gold standard" standalone course)

## SEO Content
PAGE_TITLE: Tennessee Personal Finance Curriculum - PFL Academy | 6 Categories Aligned
META_DESCRIPTION: Tennessee Personal Finance Curriculum aligned to 6 comprehensive categories. Complete 45-chapter program meeting 0.5 credit graduation requirement since 2013.
KEYWORDS: Tennessee personal finance, TN financial literacy, 6 categories, 0.5 credit requirement, tennessee teachers, Tennessee Promise

## Hero Section
HERO_TITLE: Tennessee Personal Finance Curriculum
HERO_DESCRIPTION: Complete 45-chapter program aligned to Tennessee's 6 Personal Finance categories, meeting the 0.5 credit graduation requirement. Tennessee is one of eight states with the "gold standard" - a standalone half-semester personal finance course.

## Quick Facts Box
QUICK_FACTS_STANDARDS: Tennessee Personal Finance Standards
QUICK_FACTS_COVERAGE: 6 Comprehensive Categories
QUICK_FACTS_GRADES: 9-12 (High School)
QUICK_FACTS_IMPLEMENTATION: 0.5 credit standalone course (or 3-year JROTC alternative)
QUICK_FACTS_NOTE: Fulfills Tennessee graduation requirement (since 2013) with "gold standard" standalone course. Features Tennessee's no state income tax advantage.

## Curriculum Alignment - Line Items
CATEGORY_1: Category 1: Financial Responsibility and Personal Decision Making (13 chapters) - Career planning, income sources, and comprehensive tax literacy featuring TN no state income tax
CATEGORY_2: Category 2: Education, Careers, and Income (4 chapters) - Goal setting, budgeting, and consumer protection fundamentals
CATEGORY_3: Category 3: Planning and Money Management (10 chapters) - Financial services, savings strategies, investment principles, and retirement planning
CATEGORY_4: Category 4: Credit and Debt (8 chapters) - Credit fundamentals, debt strategies, and entrepreneurship
CATEGORY_5: Category 5: Risk Management (5 chapters) - Insurance, risk assessment, identity theft prevention, and consumer rights
CATEGORY_6: Category 6: Saving and Investing (5 chapters) - Housing decisions, investment types, and charitable giving

## First Three Categories (Detailed)
...
## Gated Content - Remaining Categories

### Category 4: Credit and Debt (8 chapters)
Credit fundamentals, debt strategies, credit legislation, and entrepreneurship

### Category 5: Risk Management (5 chapters)
Insurance, risk assessment, identity theft prevention, and consumer rights

### Category 6: Saving and Investing (5 chapters)
Housing decisions, investment types, and charitable giving

## L-Chapter Mappings for Dev Team
L_CHAPTER_MAPPINGS: L-1→1.1|L-2→1.2|L-3→1.3|L-41→1.4|L-45→1.5|L-42→1.6|L-43→1.7|L-44→1.8|L-6→1.9|L-7→1.10|L-8→1.11|L-9→1.12|L-10→1.13|L-4→2.1|L-5→2.2|L-27→2.3|L-28→2.4|L-11→3.1|L-12→3.2|L-13→3.3|L-14→3.4|L-15→3.5|L-16→3.6|L-17→3.7|L-18→3.8|L-19→3.9|L-20→3.10|L-21→4.1|L-22→4.2|L-23→4.3|L-24→4.4|L-25→4.5|L-26→4.6|L-38→4.7|L-46→4.8|L-33→5.1|L-34→5.2|L-35→5.3|L-29→5.4|L-36+L-37→5.5|L-30→6.1|L-31→6.2|L-32→6.3|L-47→6.4|L-39+L-40→6.5

### Category 4: Credit and Debt
CATEGORY_4_NUMBER: 4
...
CHAPTERS_CONSOLIDATED: 2 combinations (L-36+L-37 into 5.5, L-39+L-40 into 6.5)
TOTAL_CHAPTERS: 45 distributed across 6 Tennessee categories with sub-section organization for Category 1
SPECIAL_REQUIREMENTS: Tennessee NO state income tax (major advantage), sales tax structure, Tennessee Promise, Hope Scholarship, Tennessee Reconnect, TN Consumer Protection Act, 0.5 credit requirement (since 2013), JROTC alternative
CURRICULUM_STATUS: Ready for implementation - all 45 chapters mapped to 6 categories with corrected L-chapter titles and sub-section organization for content coherence
