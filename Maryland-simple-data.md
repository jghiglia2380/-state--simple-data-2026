# Maryland State Data - Simple Implementation

## Basic State Information
STATE_NAME: Maryland
STATE_NAME_LOWER: maryland
STANDARDS_NAME: Maryland Personal Financial Literacy Standards
STANDARDS_CODE: Maryland State Board of Education Regulations (2011), COMAR 13A.04.13
STANDARDS_COUNT: 6
STANDARDS_TERM: Standard
STANDARDS_TERM_PLURAL: Standards
COMPLIANCE_REQUIREMENT: Required instruction K-12, flexible implementation - some districts require standalone course for graduation

## SEO Content
PAGE_TITLE: Maryland Personal Financial Literacy Curriculum - PFL Academy | 6 Standards Aligned
META_DESCRIPTION: Maryland Personal Financial Literacy Curriculum aligned to 6 state standards. Complete 45-chapter program supporting flexible standalone or embedded instruction models.
KEYWORDS: Maryland financial literacy, MSDE standards, personal finance curriculum Maryland, maryland teachers, MD Consumer Protection Act

## Hero Section
HERO_TITLE: Maryland Personal Financial Literacy Curriculum
HERO_DESCRIPTION: Complete 45-chapter program aligned to Maryland's 6 Personal Financial Literacy Standards, supporting flexible implementation for both standalone courses and embedded instruction per MSDE regulations.

## Quick Facts Box
QUICK_FACTS_STANDARDS: Maryland Personal Financial Literacy Standards
QUICK_FACTS_COVERAGE: 6 Comprehensive Standards
QUICK_FACTS_GRADES: 9-12 (High School)
QUICK_FACTS_IMPLEMENTATION: Flexible standalone course or embedded instruction
QUICK_FACTS_NOTE: Fulfills Maryland State Board of Education requirements (2011) with flexible district-level implementation. Supports graduation requirement in participating districts.

## Curriculum Alignment - Line Items
STANDARD_1: Standard 1: Make Informed, Financially Responsible Decisions (6 chapters) - Financial goals, consumer protection, and decision-making
STANDARD_2: Standard 2: Relate Careers and Income (13 chapters) - Career planning, income sources, and comprehensive tax literacy
STANDARD_3: Standard 3: Manage a Budget (6 chapters) - Banking services, budgeting, and money management
STANDARD_4: Standard 4: Manage Credit and Debt (10 chapters) - Credit fundamentals, debt strategies, and housing finance
STANDARD_5: Standard 5: Create Wealth Through Saving and Investing (5 chapters) - Savings strategies, investment principles, and retirement planning
STANDARD_6: Standard 6: Manage Risks (5 chapters) - Risk assessment, insurance, and consumer protection
...
### Standard 4: Manage Credit and Debt (10 chapters)
Credit fundamentals, debt strategies, and housing finance

### Standard 5: Create Wealth Through Saving and Investing (5 chapters)
Savings strategies, investment principles, and retirement planning

### Standard 6: Manage Risks (5 chapters)
Risk assessment, insurance, and consumer protection

## L-Chapter Mappings for Dev Team
L_CHAPTER_MAPPINGS: L-4→1.1|L-5→1.2|L-27→1.3|L-28→1.4|L-29→1.5|L-39+L-40→1.6|L-1→2.1|L-2→2.2|L-3→2.3|L-41→2.4|L-45→2.5|L-42→2.6|L-43→2.7|L-44→2.8|L-6→2.9|L-7→2.10|L-8→2.11|L-9→2.12|L-10→2.13|L-11→3.1|L-12→3.2|L-13→3.3|L-14→3.4|L-15→3.5|L-16→3.6|L-21→4.1|L-22→4.2|L-23→4.3|L-24→4.4|L-25→4.5|L-26→4.6|L-38→4.7|L-30→4.8|L-31→4.9|L-32→4.10|L-17→5.1|L-18→5.2|L-19→5.3|L-20→5.4|L-47→5.5|L-33→6.1|L-34→6.2|L-35→6.3|L-36+L-37→6.4|L-46→6.5
...
TOTAL_CHAPTERS: 45 distributed across 6 Maryland standards with clean organization (no sub-sections needed)
SPECIAL_REQUIREMENTS: Maryland progressive income tax (2%-5.75%), local income tax (county-level), MD College Investment Plan (529), MD Prepaid College Trust, Consumer Protection Act, federal government career emphasis, biotechnology sector, flexible implementation model (standalone or embedded)
CURRICULUM_STATUS: Ready for implementation - all 45 chapters mapped to 6 standards with corrected L-chapter titles and clean organization
