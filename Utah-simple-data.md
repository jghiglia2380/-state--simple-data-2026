# Utah State Data - Simple Implementation

## Basic State Information
STATE_NAME: Utah
STATE_NAME_LOWER: utah
STANDARDS_NAME: Utah General Financial Literacy Core Standards (GFL)
STANDARDS_CODE: Utah Code 53E-3-505; Course 01.00.00.00.100
STANDARDS_COUNT: 5
STANDARDS_TERM: Strand
STANDARDS_TERM_PLURAL: Strands
COMPLIANCE_REQUIREMENT: 0.5-credit General Financial Literacy course required for graduation (since 2008, first state in nation). Statewide end-of-course exam via YouScience (74% cut score)

## SEO Content
PAGE_TITLE: Utah General Financial Literacy Curriculum - PFL Academy | 5 Strands Aligned
META_DESCRIPTION: Utah General Financial Literacy Curriculum aligned to 5 comprehensive Strands from Utah Core Standards. Complete 45-chapter program meeting Utah's pioneering 0.5-credit GFL graduation requirement since 2008 with YouScience end-of-course assessment.
KEYWORDS: Utah General Financial Literacy, GFL curriculum, 5 Strands, Utah Core Standards, YouScience assessment, utah teachers, first state financial literacy, Course 01.00.00.00.100

## Hero Section
HERO_TITLE: Utah General Financial Literacy (GFL) Curriculum
HERO_DESCRIPTION: Complete 45-chapter program aligned to Utah's 5 GFL Core Strands, meeting the 0.5-credit graduation requirement. Utah was the first state in the nation to mandate financial literacy education (2008).

## Quick Facts Box
QUICK_FACTS_STANDARDS: Utah General Financial Literacy Core Standards (USBE via UEN)
QUICK_FACTS_COVERAGE: 5 Strands (economic concepts, decision-making, income/careers, saving/investing, money management/credit)
QUICK_FACTS_GRADES: 11-12 (Juniors and Seniors)
QUICK_FACTS_IMPLEMENTATION: 0.5-credit course (online, traditional, or concurrent enrollment) with statewide YouScience end-of-course exam (74% cut score)
QUICK_FACTS_NOTE: Fulfills Utah Code 53E-3-505 graduation requirement (since 2008). First-in-nation financial literacy mandate with comprehensive statewide assessment.

## Curriculum Alignment - Line Items
STRAND_1: Strand 1: Economic Concepts and Economic Thinking (5 chapters) - Basic economic concepts and economic thinking critical to personal financial choices
STRAND_2: Strand 2: Personal Financial Priorities and Rational Decisions (6 chapters) - Factors influencing personal financial priorities and rational decision-making
STRAND_3: Strand 3: Income Sources and Career Preparation (10 chapters) - Sources of income and relationship between career preparation and lifetime earning power
STRAND_4: Strand 4: Saving Methods and Investment Strategies (13 chapters) - Saving methods, investment strategies, financial institutions, and risk management/insurance
STRAND_5: Strand 5: Personal Money Management, Budgeting, and Credit (11 chapters) - Money management principles, budgeting, account management, credit, and consumer protection
...
## Gated Content - Remaining Standard

### Standard 4: Housing, Risk Management & Life Planning (8 chapters)
Housing decisions, insurance, consumer protection, and life planning

## L-Chapter Mappings for Dev Team
L_CHAPTER_MAPPINGS: L-1→1.1|L-2→1.2|L-3→1.3|L-41→1.4|L-45→1.5|L-42→1.6|L-43→1.7|L-44→1.8|L-6→1.9|L-7→1.10|L-8→1.11|L-9→1.12|L-10→1.13|L-4→2.1|L-5→2.2|L-27→2.3|L-28→2.4|L-11→2.5|L-12→2.6|L-13→2.7|L-14→2.8|L-15→2.9|L-29→2.10|L-21→3.1|L-22→3.2|L-23→3.3|L-24→3.4|L-25→3.5|L-26→3.6|L-38→3.7|L-16→3.8|L-17→3.9|L-18→3.10|L-19→3.11|L-20→3.12|L-47→3.13|L-46→3.14|L-30→4.1|L-31→4.2|L-32→4.3|L-33→4.4|L-34→4.5|L-35→4.6|L-36+L-37→4.7|L-39+L-40→4.8

### Standard 4: Housing, Risk Management & Life Planning
STANDARD_4_NUMBER: 4
...
CHAPTERS_CONSOLIDATED: 2 combinations (L-36+L-37 into 4.7, L-39+L-40 into 4.8)
TOTAL_CHAPTERS: 45 distributed across 4 Utah standards with sub-section organization for Standards 1 and 2
SPECIAL_REQUIREMENTS: Utah flat income tax (4.85%), my529 plan, Regents' Scholarship, Silicon Slopes tech ecosystem, Consumer Sales Practices Act, GFL end-of-course assessment, first-in-nation mandate (2008)
CURRICULUM_STATUS: Ready for implementation - all 45 chapters mapped to 4 standards with corrected L-chapter titles and sub-section organization for content coherence
