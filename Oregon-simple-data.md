# Oregon State Data - Simple Implementation

## Basic State Information
STATE_NAME: Oregon
STATE_NAME_LOWER: oregon
STANDARDS_NAME: Oregon Social Science Standards: Personal Finance
STANDARDS_CODE: Senate Bill 3 (2023) - Social Science Standards adopted June 13, 2024
STANDARDS_COUNT: 5
STANDARDS_TERM: Domain
STANDARDS_TERM_PLURAL: Domains
COMPLIANCE_REQUIREMENT: Half-credit personal finance course graduation requirement (Class of 2027+ / diplomas awarded January 1, 2027 and after)

## SEO Content
PAGE_TITLE: Oregon Personal Finance Curriculum - PFL Academy | 5 Domains Aligned
META_DESCRIPTION: Oregon Personal Finance Curriculum aligned to 5 domains from Oregon Social Science Standards. Complete 45-chapter program meeting half-credit graduation requirement for Class of 2027 and beyond.
KEYWORDS: Oregon personal finance, Senate Bill 3, 5 domains, Class of 2027, oregon teachers, HECPS, social science standards

## Hero Section
HERO_TITLE: Oregon Personal Financial Education Curriculum
HERO_DESCRIPTION: Complete 45-chapter program aligned to Oregon's 5 Personal Finance Domains, meeting the half-credit graduation requirement established by Senate Bill 3 for Class of 2027 and beyond.

## Quick Facts Box
QUICK_FACTS_STANDARDS: Oregon Social Science Standards: Personal Finance (adopted June 13, 2024)
QUICK_FACTS_COVERAGE: 5 Domains (Financial Decision-Making, Earning/Income/Careers, Spending/Saving, Borrowing/Credit, Investing)
QUICK_FACTS_GRADES: 9-12 (High School)
QUICK_FACTS_IMPLEMENTATION: Half-credit course (60 hours)
QUICK_FACTS_NOTE: Fulfills Oregon SB3 graduation requirement (Class of 2027+) with Oregon Saves integration and HECPS coordination

## Curriculum Alignment - Line Items
DOMAIN_1: Domain 1: Financial Decision-Making (8 chapters) - Goal setting, planning, consumer decisions, and financial protection
DOMAIN_2: Domain 2: Earning, Income and Careers (10 chapters) - Career exploration, education financing, income sources, taxation, and workforce readiness
DOMAIN_3: Domain 3: Spending and Saving (12 chapters) - Budgeting, banking, spending strategies, housing, auto finance, and saving fundamentals
DOMAIN_4: Domain 4: Borrowing and Credit (8 chapters) - Credit fundamentals, debt management, student loans, and identity theft protection
DOMAIN_5: Domain 5: Investing (7 chapters) - Investment principles, retirement planning, risk management, and insurance

## First Three Domains (Detailed)
...
GATED_DOMAINS: Domain 4: Borrowing and Credit|Domain 5: Investing

GATED_FEATURES: Credit Score Simulator|Debt Management Calculator|Investment Portfolio Builder|Retirement Planner|Oregon Saves Auto-IRA Calculator|Insurance Coverage Analyzer

## Oregon Resource Links
...
NEW_CHAPTERS_REQUIRED: 0 - using L-1 through L-46 from master inventory
CHAPTERS_CONSOLIDATED: 2 combinations (L-36+L-37 into 1.7, L-39+L-40 into 1.6)
TOTAL_CHAPTERS: 45 distributed across 5 Oregon Domains
SPECIAL_REQUIREMENTS: Oregon flat income tax (9%), Oregon Saves Auto-IRA program, Senate Bill 3 compliance, HECPS coordination, Oregon College Savings Plan
CURRICULUM_STATUS: Ready for implementation - corrected to 5 domains per Oregon Social Science Standards (adopted June 13, 2024)
CRITICAL_FIX: Reduced from 8 standards to 5 domains per official Oregon DOE structure
LAST_UPDATED: February 3, 2026 - Complete restructure to 5 domains matching Oregon Social Science Standards
